         ...
         <div className="px-5 md:pl-48 ">
            <div >
               <div data-aos="flip-left">
                  <h2 className="text-6xl font-bold text-center  text my-20 text-primary title uppercase ">
                     {name}
                  </h2>
               ...
               <div>
                  <h3 className=" font-bold title2 text-3xl capitalize ">
                     Project pages:{" "}
                  </h3>
               ...
               <div>
                  ...
                  <div className="flex flex-wrap gap-5 mb-20 justify-center">
                     <a
                        href={clientside}
                        className="px-10 rounded-lg  py-2 bg-primary text-secondary text-xl  font-bold capitalize"
                     >
                        Github Clientside
                     </a>
                     <a
